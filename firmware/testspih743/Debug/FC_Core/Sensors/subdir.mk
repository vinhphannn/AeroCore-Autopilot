...
CPP_SRCS += \
../FC_Core/Sensors/SensorHub.cpp 

OBJS += \
./FC_Core/Sensors/SensorHub.o 

CPP_DEPS += \
./FC_Core/Sensors/SensorHub.d 


# Each subdirectory must supply rules for building sources it contributes
FC_Core/Sensors/%.o FC_Core/Sensors/%.su FC_Core/Sensors/%.cyclo: ../FC_Core/Sensors/%.cpp FC_Core/Sensors/subdir.mk
...
clean: clean-FC_Core-2f-Sensors

clean-FC_Core-2f-Sensors:
	-$(RM) ./FC_Core/Sensors/SensorHub.cyclo ./FC_Core/Sensors/SensorHub.d ./FC_Core/Sensors/SensorHub.o ./FC_Core/Sensors/SensorHub.su

.PHONY: clean-FC_Core-2f-Sensors
