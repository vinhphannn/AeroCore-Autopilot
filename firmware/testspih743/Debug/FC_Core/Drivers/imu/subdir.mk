...
CPP_SRCS += \
../FC_Core/Drivers/imu/icm42688p.cpp 

OBJS += \
./FC_Core/Drivers/imu/icm42688p.o 

CPP_DEPS += \
./FC_Core/Drivers/imu/icm42688p.d 


# Each subdirectory must supply rules for building sources it contributes
FC_Core/Drivers/imu/%.o FC_Core/Drivers/imu/%.su FC_Core/Drivers/imu/%.cyclo: ../FC_Core/Drivers/imu/%.cpp FC_Core/Drivers/imu/subdir.mk
...
clean: clean-FC_Core-2f-Drivers-2f-imu

clean-FC_Core-2f-Drivers-2f-imu:
	-$(RM) ./FC_Core/Drivers/imu/icm42688p.cyclo ./FC_Core/Drivers/imu/icm42688p.d ./FC_Core/Drivers/imu/icm42688p.o ./FC_Core/Drivers/imu/icm42688p.su

.PHONY: clean-FC_Core-2f-Drivers-2f-imu
