...
CPP_SRCS += \
../FC_Core/Drivers/SensorCallbacks.cpp 

OBJS += \
./FC_Core/Drivers/SensorCallbacks.o 

CPP_DEPS += \
./FC_Core/Drivers/SensorCallbacks.d 


# Each subdirectory must supply rules for building sources it contributes
FC_Core/Drivers/%.o FC_Core/Drivers/%.su FC_Core/Drivers/%.cyclo: ../FC_Core/Drivers/%.cpp FC_Core/Drivers/subdir.mk
...
clean: clean-FC_Core-2f-Drivers

clean-FC_Core-2f-Drivers:
	-$(RM) ./FC_Core/Drivers/SensorCallbacks.cyclo ./FC_Core/Drivers/SensorCallbacks.d ./FC_Core/Drivers/SensorCallbacks.o ./FC_Core/Drivers/SensorCallbacks.su

.PHONY: clean-FC_Core-2f-Drivers
