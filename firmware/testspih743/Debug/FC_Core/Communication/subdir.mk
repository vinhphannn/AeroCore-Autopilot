...
CPP_SRCS += \
../FC_Core/Communication/mavlink_main.cpp 

OBJS += \
./FC_Core/Communication/mavlink_main.o 

CPP_DEPS += \
./FC_Core/Communication/mavlink_main.d 


# Each subdirectory must supply rules for building sources it contributes
FC_Core/Communication/%.o FC_Core/Communication/%.su FC_Core/Communication/%.cyclo: ../FC_Core/Communication/%.cpp FC_Core/Communication/subdir.mk
...
clean: clean-FC_Core-2f-Communication

clean-FC_Core-2f-Communication:
	-$(RM) ./FC_Core/Communication/mavlink_main.cyclo ./FC_Core/Communication/mavlink_main.d ./FC_Core/Communication/mavlink_main.o ./FC_Core/Communication/mavlink_main.su

.PHONY: clean-FC_Core-2f-Communication
